...
class LogDebugPrint {
  ...
  static void write(LogRecord event) {
    ...
    _formatAndPrint(event.level, event.loggerName, messageStr, event.time, stackTraceStr);
  }
  ...
  static void _formatAndPrint(LogLevel level, String logggerName, String message, DateTime time, String stacktrace) {
    ...
    if (time != null) {
      debugPrint(color('$_verticalLine $time'));
      debugPrint(color(_middleBorder));
    }
