...
class AppInfo {
  ...
  static Map<String, dynamic> _getAndroidDeviceInfo(AndroidDeviceInfo androidDeviceInfo) {
    ...
    deviceInfo['board'] = androidDeviceInfo.board;
    deviceInfo['bootloader'] = androidDeviceInfo.bootloader;
    ...
    deviceInfo['tags'] = androidDeviceInfo.tags;
    ...
    deviceInfo['versionPreviewSdk'] = androidDeviceInfo.version.previewSdkInt;
